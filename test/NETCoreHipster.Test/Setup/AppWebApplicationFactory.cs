...
using NETCoreHipster.Configuration;
using NETCoreHipster.Security;
using NETCoreHipster.Test.Configuration;
...
namespace NETCoreHipster.Test.Setup;
    ...
    where TEntryPoint : class, IStartup, new()
{
    ...
    {
        builder
            .UseSolutionRelativeContentRoot("src/NETCoreHipster")
