...
using AuthenticationService = NETCoreHipster.Domain.Services.AuthenticationService;
using IAuthenticationService = NETCoreHipster.Domain.Services.Interfaces.IAuthenticationService;

namespace NETCoreHipster.Configuration;
